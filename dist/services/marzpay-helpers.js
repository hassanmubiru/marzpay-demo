 ...
 */
export function isValidPhone(client, phone) {
 ...
 */
export function parseWebhookReference(rawBody) {
    let parsed;
    try {
    ...
    const root = parsed;
    const candidates = [root["reference"]];
    const data = root["data"];
    if (data !== null && typeof data === "object" && !Array.isArray(data)) {
        candidates.push(data["reference"]);
    }
...
//# sourceMappingURL=marzpay-helpers.js.map