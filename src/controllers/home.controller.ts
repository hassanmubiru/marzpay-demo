 ...
 */
const HOME_VIEW_CANDIDATES: readonly URL[] = [
 ...
 */
export async function loadHomeView(): Promise<string> {
...
export class HomeController {
   ...
   */
  loadView: () => Promise<string> = loadHomeView;
   ...
   */
  @Get("/")
  async index(ctx: StreetContext): Promise<void> {
    try {
