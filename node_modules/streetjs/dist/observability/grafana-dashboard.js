...
function gridPanel(id, title, type, x, y, targets, unit) {
...
export function streetPostgresDashboard() {
    return {
        uid: 'street-postgres',
...
export function streetKafkaDashboard() {
    return {
        uid: 'street-kafka',
        title: 'Street Kafka',
        schemaVersion: 39,
...
export function streetRabbitmqDashboard() {
    return {
        uid: 'street-rabbitmq',
...
export function streetPluginHostDashboard() {
    return {
