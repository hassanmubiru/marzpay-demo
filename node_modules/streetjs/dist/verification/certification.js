 ...
 */
export const CONSUMER_PLATFORM_CAPABILITIES = Object.freeze([
    'validation.runtime',
 ...
 */
function resolveCapability(capabilityId, byCapability) {
 ...
 */
export function computeCertification(artifacts, now = new Date()) {
    ...
    const categories = REPORT_CATEGORIES.map((category) => {
        ...
        const unverified = contributing.filter((c) => !c.hasArtifact || c.status !== 'VERIFIED');
        return {
            category,
